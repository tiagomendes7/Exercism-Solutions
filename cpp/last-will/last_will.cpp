...
namespace estate_executor {
    ...
    int assemble_code() {
        int add_blue = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
        int add_red  = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
        return add_blue * add_red;
    }
}